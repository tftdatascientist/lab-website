    ...
    <section className="py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          ...
          <div className="hidden lg:block absolute top-8 left-[calc(12.5%+24px)] right-[calc(12.5%+24px)] h-px bg-gradient-to-r from-cyan to-amber opacity-30" />

          {steps.map((step) => (
            <div key={step.num} className="relative text-center lg:text-center">
              {/* Circle */}
              <div className="relative z-10 mx-auto w-16 h-16 rounded-full border border-white/[0.08] bg-bg-card flex items-center justify-center mb-5">
                <span className="font-heading text-xl font-bold bg-gradient-to-r from-cyan to-amber bg-clip-text text-transparent">
                  {step.num}
                </span>
              </div>
