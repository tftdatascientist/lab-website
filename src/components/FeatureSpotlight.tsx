  ...
  return (
    <section className="py-24 md:py-32 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        {/* Mobile: Simple image card with text overlay */}
        <div className="lg:hidden">
          <div className="relative rounded-2xl overflow-hidden ghost-border bg-surface-container aspect-[4/5]">
            <Image
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <h2 className="text-2xl font-bold font-heading tracking-tight mb-2 leading-tight">
                Technologia Jutra
              </h2>
              <p className="text-sm text-on-surface-variant leading-relaxed">
                Tworzymy ekosystemy, które pracują, gdy Ty odpoczywasz. Pełna
                automatyzacja procesów CRM i&nbsp;sprzedaży.
              </p>
            </div>
          </div>
        </div>
